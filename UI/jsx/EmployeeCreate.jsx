					...
					<>
						...
						<form onSubmit={this.handleSubmit}>
							<div className="form-group">
								<label htmlFor="FirstName" className={!(this.props.deleteEmployee || this.props.updateEmployee) ? 'required' : ''}>
									First Name
								</label>
							...
							<div className="form-group">
								<label htmlFor="LastName" className={!(this.props.deleteEmployee || this.props.updateEmployee) ? 'required' : ''}>
									Last Name
								</label>
							...
							<div className="form-group">
								<label htmlFor="DateOfJoining" className={!(this.props.deleteEmployee || this.props.updateEmployee) ? 'required' : ''}>
									Date of Joining
								</label>
							...
							<div className="form-group">
								<label htmlFor="Title" className={!(this.props.deleteEmployee || this.props.updateEmployee) ? 'required' : ''}>
									Title
								</label>
							...
							<div className="form-group">
								<label htmlFor="Department" className={!(this.props.deleteEmployee || this.props.updateEmployee) ? 'required' : ''}>
									Department
								</label>
							...
							<div className="form-group">
								<label htmlFor="EmployeeType" className={!(this.props.deleteEmployee || this.props.updateEmployee) ? 'required' : ''}>
									Employee Type
								</label>
							...
							{this.props.updateEmployee ? (
								<div className="form-group">
									<label htmlFor="CurrentStatus" className={!(this.props.deleteEmployee || this.props.updateEmployee) ? 'required' : ''}>
										Current Status
									</label>
